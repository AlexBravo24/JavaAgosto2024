...
public class ClienteDAO implements Metodos {
	...
	// ¿Que diferencia existe en utilizar HIBERNATE y JDBC nativo?
	
	// El uso de FRAMEWORKS como HIBERNATE nos ayuda a ganar velocidad de desarrollo
	// al disminuir las lineas de codigo, pero.... obtenemos una respuesta
	// en las peticiones mas "lenta"
	
	// Con una conexión mediante JDBC nos lleva más tiempo en desarrollar por que es más 
	// codigo pero la respuesta en el servidor es mas rápida.
