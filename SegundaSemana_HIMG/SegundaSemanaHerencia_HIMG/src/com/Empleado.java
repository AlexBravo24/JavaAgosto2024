...
public class Empleado extends Persona {
	// Aqui solo declaramos los atributos propios de un empleado por que los de Persona
	...
	// Para poder crear un Empleado con todos los atributos incluyendo los de la clase 	Persona
	// debemos elegir el constructor también de la clase Persona, al momento de generarlo.
	...
	// La clases hijas se ven obligadas a definir los métodos abstractos
